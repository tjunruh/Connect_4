...
//void connect4_operations::save_board() {
//	for (int i = 0; i < 6; i++) {
//		for (int j = 0; j < 7; j++) {
...
//void connect4_operations::restore_board() {
//	for (int i = 0; i < 6; i++) {
//		for (int j = 0; j < 7; j++) {
...
void connect4_operations::minimax(string (&board)[6][7], int& column, int& value, int depth, int alpha, int beta, bool maximizing_player) {
	...
	if (maximizing_player) {
		...
		for (int i = 0; i < num_open_columns; i++) {
			...
			place_piece(ai_player, open_columns[i], board_copy);
		...
		for (int i = 0; i < num_open_columns; i++) {
			copy_board(board, board_copy);
			place_piece(human_player, open_columns[i], board_copy);
